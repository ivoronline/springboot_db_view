...
INSERT INTO PERSON (NAME, AGE, ADDRESS_ID) VALUES ('John' , 10, (SELECT ID FROM ADDRESS WHERE CITY = 'London'));
INSERT INTO PERSON (NAME, AGE, ADDRESS_ID) VALUES ('Bill' , 20, (SELECT ID FROM ADDRESS WHERE CITY = 'Boston'));
INSERT INTO PERSON (NAME, AGE, ADDRESS_ID) VALUES ('Susan', 30, (SELECT ID FROM ADDRESS WHERE CITY = 'Sydney'));
